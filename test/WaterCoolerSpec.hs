...
spec = do
  ...
  describe "secondsToHumanString" $ do
    ...
    it "7199" $ secondsToHumanString 7199 `shouldBe` "1h:59m"
    it "86399" $ secondsToHumanString 86399 `shouldBe` "23h:59m"
    ...
    it "-1.3145" $ secondsToHumanString (-1.3145) `shouldBe` "-1s"
    it "86490" $ secondsToHumanString 86490 `shouldBe` "1d:1m"
    it "-86490" $ secondsToHumanString (-86490) `shouldBe` "-1d:1m"
    it "90090" $ secondsToHumanString 90090 `shouldBe` "1d:1h:1m"
    it "-90090" $ secondsToHumanString (-90090) `shouldBe` "-1d:1h:1m"
